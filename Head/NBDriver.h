...
#define     NB_SEND_DATA_LWM2M      "AT+NMGS="	//通过LWM2M协议发送数据,禾苗
#define     NB_SEND_DATA_LWM2M_RAI	"AT+MLWULDATAEX="	//通过LWM2M协议发送带有RAI标识的数据
#define		SERVER_BAND				"5"					//配置NB模块频段	5，电信 8，移动、联通
#define		SERVER_ADDRESS			"180.101.147.115"	//NB模块注册地址
#define		SERVER_PORT				"5683"				//NB模块端口

#define     CON_SENDING_STATUS		"AT+QLWULDATASTATUS?\r\n"	//查询NB数据发送情况
#define		NB_DATA_RECEIVE			"not badge cmd\r\n"				//NB平台下发数据前缀
...
#define		SINGAL_DETECT				"AT+CSQ\r\n"		//信号强度检测
#define		NETWORK_DETECT				"AT+CGATT?\r\n"		//驻网检测
...
extern unsigned char NBdata_Receive_HW(unsigned char *Repl_str, unsigned char *Get_str, unsigned char *len);
