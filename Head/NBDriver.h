...
#define		NB_RETRY_TIME			60*60					//初始化失败重试时间s
#define		NB_Init_OK				0xA5
#define     NB_Init_NOT_OK			0x00
#define		NB_Init_Reset			0x5A
...
extern unsigned char NBdata_Receive_MTK(unsigned char *Repl_str, unsigned char *Get_str, unsigned char *len);
